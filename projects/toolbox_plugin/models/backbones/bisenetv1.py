...
from depth.models.builder import BACKBONES, build_backbone
...
class BiSeNetV1(BaseModule):
    ...
    def __init__(self,
        ...
        self.ffm = FeatureFusionModule(context_channels[0] + spatial_channels[-1], out_channels)
    ...
    def forward(self, x):
        ...
        # torch.Size([16, 48, 15, 20])
        # torch.Size([16, 24, 15, 20])
        # torch.Size([16, 24, 8, 10])
