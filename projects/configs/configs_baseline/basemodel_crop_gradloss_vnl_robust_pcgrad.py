...
# optimizer
max_lr=4e-3
optimizer = dict(constructor='PCGradOptimizerConstructor', type='Adam', lr=max_lr, betas=(0.9, 0.999), eps=1e-3, weight_decay=0, amsgrad=False)
...
optimizer_config = dict(type='PCGradOptimizerHook', grad_clip=dict(max_norm=35, norm_type=2))
# runtime settings
