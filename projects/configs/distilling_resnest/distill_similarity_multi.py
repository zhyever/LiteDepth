...
teacher_model_cfg = dict(
    ...
    init_cfg=dict(
        type='Pretrained', 
        checkpoint='nfs/mobileAI2022/teacher/resnest101/epoch_200.pth'),
    backbone=dict(
...
model=dict(
    ...
    distill_loss=dict(type='SimilarityMSELoss', loss_weight=100.0),
    teacher_select_de_index=(1, 2, 3),
    student_select_de_index=(1, 2, 3),
    layer_weights=(1, 1, 1),
    train_cfg=dict(),
    test_cfg=dict(mode='whole')
)
