...
teacher_model_cfg = dict(
    ...
    init_cfg=dict(
        type='Pretrained', 
        checkpoint='nfs/checkpoints/swinl_w7_22k_align_decoder_extendup_bilinear.pth'),
    backbone=dict(
...
model=dict(
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint='nfs/mobileAI2022/distill_final_grad_poly_bestteacher/cwd_5e-1_t4/epoch_200.pth'),
    teacher_select_de_index=(0, 1, 2, 3),
    student_select_de_index=(0, 1, 2, 3),
